...
import org.openqa.selenium.WebElement;
 ...
 private String homeAddressInputCss="input[type='text'][name='address']";
 private String emailInputCss="input[type='email'][name='email']";
 private String submitButtonCss="button[type='submit']";
 private String settingsNotificationBarCss="div.mh-notification-bar-text";
...
public WebElement getHomeAddressInput() {
	 
	 return driver.findElement(By.cssSelector(homeAddressInputCss));
}

public WebElement getEmailInput() {
	 
	 return driver.findElement(By.cssSelector(emailInputCss));
}

public WebElement getSubmitButton() {
	 
	 return driver.findElement(By.cssSelector(submitButtonCss));
}

public WebElement getSettingsNotificationBar()
{
	return driver.findElement(By.cssSelector(settingsNotificationBarCss));
}
